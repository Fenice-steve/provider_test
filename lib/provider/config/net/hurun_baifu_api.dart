...
import 'package:flutter_dio_test/provider/view_state.dart';
import 'api.dart';
...
class Http extends BaseHttp{
  @override
  void init() {
    interceptors..add(ApiInterceptor())..add(CookieManager(PersistCookieJar(dir: StorageManager.temporaryDirectory.path)));
  }
}

/// 胡润百富 API
class ApiInterceptor extends InterceptorsWrapper{
  static const baseUrl = 'http://api.hurun.cn/';
